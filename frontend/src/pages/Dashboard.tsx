        ...
        <div className="space-y-6">
            ...
            <div className="card">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <Link to="/admin/games/new" className="btn-primary justify-center">
                        <Plus className="w-5 h-5" />
                        Add New Game
                    </Link>
                    <Link to="/admin/users" className="btn-secondary justify-center">
                        <Eye className="w-5 h-5" />
                        Manage Users
                    </Link>
                    <Link to="/admin/leaderboards" className="btn-secondary justify-center">
