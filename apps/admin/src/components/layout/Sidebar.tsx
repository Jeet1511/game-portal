...
export default function Sidebar() {
    ...
    const navigation = [
        ...
        },
        {
            ...
            icon: Gamepad2,
            children: [
                { name: 'All Games', href: '/games', icon: List },
                { name: 'Add New Game', href: '/games/new', icon: Plus },
                { name: 'Categories', href: '/games/categories', icon: FolderOpen },
            ],
        },
        {
            name: 'Users',
            ...
            children: [
                ...
                { name: 'Banned Users', href: '/users/banned', icon: UserX },
            ],
        },
        {
            name: 'Leaderboards',
